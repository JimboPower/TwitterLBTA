...
class UserCell: DatasourceCell {
    ...
    override func setupViews() {
        ...
        bioTextView.anchor(userNameLabel.bottomAnchor, left: profileImageView.rightAnchor, bottom: nil, right: self.rightAnchor, topConstant: 5, leftConstant:
            -2, bottomConstant: -7, rightConstant: 12, widthConstant: 0, heightConstant: 50)
